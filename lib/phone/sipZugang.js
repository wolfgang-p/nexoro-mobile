...
(function() {
  try {
    ...
    // Pro Seitensitzung nur einmal - der Schein ist kurzlebig, aber jeder
    // Aufruf erzeugt einen neuen Datenbankeintrag.
    if (window.sessionStorage && sessionStorage.getItem('nexoro_sip_ticket') === 'ok') return;
    ...
    .then(function(d) {
      ...
      if (window.sessionStorage) sessionStorage.setItem('nexoro_sip_ticket', 'ok');
    ...
    .catch(function() { /* offline oder abgemeldet */ });
  } catch (e) {}
})();
true;
`;
